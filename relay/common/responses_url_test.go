...
func TestResponsesUpstreamURL(t *testing.T) {
	for _, test := range []struct {
		...
		{"已带版本", "https://upstream.test/v1", "/v1/responses", constant.ChannelTypeOpenAI, "https://upstream.test/v1/responses"},
		{"尾部斜杠", "https://upstream.test/v1/", "/responses", constant.ChannelTypeOpenAI, "https://upstream.test/v1/responses"},
		...
		{"版本化压缩", "https://upstream.test/v1", "/v1/responses/compact", constant.ChannelTypeOpenAI, "https://upstream.test/v1/responses/compact"},
