...
describe('request simulation', () => {
  test('simulates an explicit reasoning effort without changing the stored expression', async () => {
    const user = userEvent.setup()
    render(
      <RequestSimulation
        expression='tier("request", fixed(0.01)) * (effort == "max" ? 2 : 1)'
        mode='token'
