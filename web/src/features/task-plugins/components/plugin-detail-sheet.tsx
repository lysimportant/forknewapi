              ...
              <Card>
                ...
                <CardContent>
                  ...
                  Object.keys(detail.meta.usageSchema).length > 0 ? (
                    <UsageSchemaTable
                      schema={detail.meta.usageSchema}
                      modelNames={detail.meta.models ?? undefined}
                      modelName={
                        detail.meta.key === 'grok-video'
                          ? 'grok-imagine-video-1.5'
                          : undefined
                      }
                      isVideo={detail.meta.protocols?.some(
                        (protocol) =>
                          (typeof protocol === 'string'
                            ? protocol
                            : protocol.name) === 'openai_video'
                      )}
                    />
                  ) : (
